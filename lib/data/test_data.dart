...
final List<TaskEntity> testTaskEntities = [
  ...
  TaskEntity.converter(id: 2, bucketId: 1, title: 'マイタスク2',),
  TaskEntity.converter(id: 3, bucketId: 1, title: 'マイタスク3'),
  TaskEntity.converter(id: 4, bucketId: 1, title: 'マイタスク4', doneAt: DateTime.now()),
  TaskEntity.converter(id: 5, bucketId: 1, title: 'マイタスク5'),
  ...
  TaskEntity.converter(id: 7, bucketId: 2, title: 'サンプルタスク2'),
  TaskEntity.converter(id: 8, bucketId: 2, title: 'サンプルタスク3'),
  TaskEntity.converter(id: 9, bucketId: 2, title: 'サンプルタスク4', doneAt: DateTime.now()),
  TaskEntity.converter(id: 10, bucketId: 2, title: 'サンプルタスク5'),
];
